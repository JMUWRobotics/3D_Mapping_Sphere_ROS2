...
#include "logitech_msgs/msg/detail/controller__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_logitech_msgs
cdr_serialize(
  const logitech_msgs::msg::Controller & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  logitech_msgs::msg::Controller & ros_message)
{
  // Member: motor_value
  cdr >> ros_message.motor_value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = logitech_msgs::msg::Controller;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const logitech_msgs::msg::Controller *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<logitech_msgs::msg::Controller *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_logitech_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<logitech_msgs::msg::Controller>()
{
  return &logitech_msgs::msg::typesupport_fastrtps_cpp::_Controller__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, logitech_msgs, msg, Controller)() {
  return &logitech_msgs::msg::typesupport_fastrtps_cpp::_Controller__handle;
}
