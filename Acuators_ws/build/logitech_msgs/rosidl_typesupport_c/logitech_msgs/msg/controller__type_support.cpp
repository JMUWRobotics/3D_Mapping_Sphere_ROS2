...
static const _Controller_type_support_symbol_names_t _Controller_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, logitech_msgs, msg, Controller)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, logitech_msgs, msg, Controller)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, logitech_msgs, msg, Controller)() {
  return &::logitech_msgs::msg::rosidl_typesupport_c::Controller_message_type_support_handle;
}
