...
In Chapter~\ref{ch:fundamentals}, we provide an overview of the fundamental concepts and technologies that relates to our work, including Inertial Measurement Units (IMUs), LiDAR technology, spherical robot types, an introduction to SLAM algorithms and Control Strategies.
...
\end{subfigure}\vspace{2mm}
%tohere
    \caption{Error Distribution Analysis(Part 2)}
