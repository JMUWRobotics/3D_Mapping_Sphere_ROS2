...
\hspace*{1em} In this research, Section 2 provides an overview of the current state-of-the-art technologies, divided into two main areas: recently developed spherical robots and the latest SLAM (Simultaneous Localization and Mapping) algorithms. Section 3 presents the hardware design of the two spherical robots developed as part of this study. This is followed by Section 4, which details the software implementations integrated into each sphere. Finally, Section 5 discusses the evaluation results of both the proposed spheres and existing state-of-the-art solutions, focusing on physical performance and mapping capabilities.
